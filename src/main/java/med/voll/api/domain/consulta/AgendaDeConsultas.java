...
import med.voll.api.domain.consulta.validacao.ValidadorCancelamentoDeConsulta;
...
public class AgendaDeConsultas {
    ...
    public DadosdetalhamentoConsultas agendar(DadosAgendamnetosConsultas dados){

...
import med.voll.api.domain.medico.DadasDeletalhamentoMedico;
...
class ConsultasControllerTest {
    ...
    @Autowired
    private JacksonTester<DadosAgendamnetosConsultas> dadosAgendamnetosConsultasJson;
    ...
    void agendar_cenario2() throws Exception {
        ...
        var response = mvc
                .perform(post("/consultas")
                        ...
                        .content(dadosAgendamnetosConsultasJson.write(
                                new DadosAgendamnetosConsultas(2l, 5l, data, especialidade)
                        ).getJson()
                        )
                )
                .andReturn().getResponse();
